    ...
    <div class="p-4 shadow-md rounded-md text-left">
      <form class="mt-8 space-y-6" action="" method="post">
        ...
        <div>
          ...
          ?>
            <select name='supervisor' class="form-select mt-1 block w-full" required>
        ...
        <div>
          <label class="block mt-4">
            ...
            ?>
            <select class="form-select mt-1 block w-full" id="doctor" name="doctor" required>
        ...
        <div>
          <label class="block mt-4">
            ...
            ?>
            <select class="form-select mt-1 block w-full" id="caregiver1" name="caregiver1" required>
        ...
        <div>
          <label class="block mt-4">
            ...
            ?>
            <select class="form-select mt-1 block w-full" id="caregiver2" name="caregiver2" required>
              <option value=''>Select a Caregiver</option>
              <?php
                foreach($arr as $r => $r_value) {
                  echo "<option value='$r'>$r_value</option>";
        ...
        <div>
          <label class="block mt-4">
            ...
            ?>
            <select class="form-select mt-1 block w-full" id="caregiver3" name="caregiver3" required>
              <option value=''>Select a Caregiver</option>
              <?php
                foreach($arr as $r => $r_value) {
                  echo "<option value='$r'>$r_value</option>";
        ...
        <div>
          <label class="block mt-4">
            ...
            ?>
            <select class="form-select mt-1 block w-full" id="caregiver4" name="caregiver4" required>
              <option value=''>Select a Caregiver</option>
              <?php
                foreach($arr as $r => $r_value) {
                  echo "<option value='$r'>$r_value</option>";
        ...
        <div>
        <input type="submit" class="btn" name="submit" value="Okay" class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
        <input type="reset" class="btn" name="submit" value="Cancel" class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
      </div>
      </form>
    </div>
  </div>
